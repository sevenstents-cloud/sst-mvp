...
function AuthProvider({ children }) {
    ...
    const [is2FAVerified, setIs2FAVerified] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    async function fetchProfile(userId) {
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('usuarios').select('*').eq('id', userId).single();
            if (error) {
...
_s1(AuthProvider, "sLAYpDCyNOuTl2zefy89vIvGOF8=", false, function() {
    return [
